...
Proportion scales for 1hr and 2hr bins are quite different.

For 1-hour bins, bin_length = 3600 seconds. For 2-hour bins, bin_length = 7200 seconds
Wetness intervals are averaged over a larger time when bins = 2hrs, so when you aggregate over a longer period it's les sliekly for the bin to contain a higher wetness level. 
...
Number of switches mor ein detail here for 1hr bins
