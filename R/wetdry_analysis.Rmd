...
plot_switch <- plot_metrics(example_daily_metrics, "total_switches", 
                            "Number of switches", 
...
So for these two birds we see a good trend, in Oct and Nov 2017 there is a low amount of wet periods, and in June and July 2018 as well. Between Dec 2017 and May 2018 there is a high proportion of wet periods. 
...
ggplot(plot_data, aes(x=datetime_start, y=wets, color=bird_id)) +
  geom_line() +
  labs(
  ...
  scale_y_continuous(
    breaks = seq(0, 20, 5), 
    labels = c("Dry", "Low Wet", "Moderate Wet", "High Wet", "Very Wet"))  +
  theme_minimal()
